<?php
/**
 * Erlandsson Bygg i Väst AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Erlandsson Bygg i Väst AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through er_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'erlandssonbyggivast', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'erlandssonbyggivast' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'erlandssonbyggivast' ) ) );

		register_block_pattern_category( 'erlandssonbyggivast-sections', array( 'label' => __( 'Erlandsson Bygg i Väst AB sections', 'erlandssonbyggivast' ) ) );
		register_block_pattern_category( 'erlandssonbyggivast-pages', array( 'label' => __( 'Erlandsson Bygg i Väst AB page layouts', 'erlandssonbyggivast' ) ) );
	}
);
