...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'erlandssonbyggivast-leads' ),
				'storm'       => __( 'Storm or hail damage', 'erlandssonbyggivast-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'erlandssonbyggivast-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'erlandssonbyggivast-leads' ),
				'not-sure'    => __( 'Vet inte än', 'erlandssonbyggivast-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'erlandssonbyggivast-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'erlandssonbyggivast-leads' ),
				'research' => __( 'Jag kollar bara priser', 'erlandssonbyggivast-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'erlandssonbyggivast-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'erlandssonbyggivast-leads' ),
		'contacted' => __( 'Kontaktad', 'erlandssonbyggivast-leads' ),
		'quoted'    => __( 'Quote sent', 'erlandssonbyggivast-leads' ),
		'won'       => __( 'Won', 'erlandssonbyggivast-leads' ),
		'lost'      => __( 'Lost', 'erlandssonbyggivast-leads' ),
		'spam'      => __( 'Misstänkt spam', 'erlandssonbyggivast-leads' ),
	);
}
